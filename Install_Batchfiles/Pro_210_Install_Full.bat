...
REM デスクトップのインストール
echo ArcGIS Pro 2.1 のインストールを開始します
...
echo ArcGIS Pro 2.1 本体のインストール... インストールにはしばらく時間がかかります...
...
echo ArcGIS Pro 2.1 日本語パック のインストール...
...
echo ArcGIS Pro 2.1 Patch 3 のインストール 
%windir%\System32\msiexec.exe /p "%curpath%\ArcGISPro_Patches\ArcGIS_Pro_213_163439.msp" /norestart /passive /qb
...
echo 注1)ArcGIS Pro 2.1 用 ST_Geometry ライブラリ と ST_Raster ライブラリ は必要に応じてインストールしてください
