...
REM デスクトップのインストール
echo ArcGIS Pro 3.03 のインストールを開始します
...
echo ArcGIS Pro 3.03 本体のインストール... インストールにはしばらく時間がかかります...
...
echo ArcGIS Pro 3.03 日本語パック のインストール...
...
echo ArcGIS Pro 3.03 のインストール終了
echo.
...
REM echo ArcGIS Pro 3.03 Data Interoperability のインストール...
...
REM echo ArcGIS Pro 3.03 Data Interoperability のインストール終了
REM echo.
...
REM その他:日本用地図シンボルなど
echo.
echo 注1)ArcGIS Pro 3.03 用 データベースサポートファイル は必要に応じてMy Esriから入手してインストールしてください
