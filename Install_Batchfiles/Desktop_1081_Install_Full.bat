@echo off
REM 
REM ArcGIS Desktop 10.8.1 の一括インストール
REM 
REM 以下を参考にして編集しました
...
REM デスクトップのインストール
echo ArcGIS Desktop 10.8.1のインストールを開始します
...
echo ArcGIS Desktop 10.8.1 のインストール... インストールにはしばらく時間がかかります...
REM Install ArcGIS Desktop 10.8.1
%windir%\System32\msiexec.exe /I "%curpath%\Desktop_Japanese\SetupFiles\setup.msi" /norestart /passive /qb

REM 日本語パックのインストール
echo ArcGIS Desktop 10.8.1 日本語パック のインストール...
...
%windir%\System32\msiexec.exe /I "%curpath%\Desktop_JpnPack\JpnPack_Desktop10_8_1.msi" /norestart /passive /qb
...
echo ArcGIS Desktop 10.8.1 64-bit Background Geoprocessing のインストール...
...
echo ArcGIS Desktop 10.8.1 64-bit 国内対応パックのインストール ...
%windir%\System32\msiexec.exe /I "%curpath%\Desktop_JpnPack\JpnPack_Desktop10_8_1_Background.msi" /norestart /passive /qb

:64BITEND

echo ArcGIS Desktop 10.8.1 のインストール終了
