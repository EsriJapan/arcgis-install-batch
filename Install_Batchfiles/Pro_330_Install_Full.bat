...
echo.
echo -----------------------------------
echo ArcGIS Pro 3.3 の一括インストール の対象
echo -----------------------------------
echo ・ArcGIS Pro
...
REM デスクトップのインストール
echo ArcGIS Pro 3.3 のインストールを開始します
...
echo ArcGIS Pro 3.3 本体のインストール... インストールにはしばらく時間がかかります...
...
echo ArcGIS Pro 3.3 日本語パック のインストール...
...
REM echo ArcGIS Pro 3.3 Patch 1 のインストール...
...
REM echo ArcGIS Pro 3.3 Data Interoperability のインストール...
...
REM echo ArcGIS Pro 3.3 Data Interoperability のインストール終了
REM echo.
...
REM その他:日本用地図シンボルなど
echo.
echo 注1)ArcGIS Pro 3.3 用 データベースサポートファイル は必要に応じてMy Esriから入手してインストールしてください
