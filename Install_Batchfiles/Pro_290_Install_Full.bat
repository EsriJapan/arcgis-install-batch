...
echo.
echo -----------------------------------
echo ArcGIS Pro 2.9 の一括インストール の対象
echo -----------------------------------
echo ・ArcGIS Pro
...
REM デスクトップのインストール
echo ArcGIS Pro 2.9 のインストールを開始します
...
echo ArcGIS Pro 2.9 本体のインストール... インストールにはしばらく時間がかかります...
...
echo ArcGIS Pro 2.9 日本語パック のインストール...
...
REM echo ArcGIS Pro 2.9 Data Interoperability のインストール...
...
REM その他:日本用地図シンボルなど
echo.
echo 注1)ArcGIS Pro 2.9 用 データベースサポートファイル は必要に応じてMy Esriから入手してインストールしてください
