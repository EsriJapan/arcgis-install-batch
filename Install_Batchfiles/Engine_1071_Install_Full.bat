@echo off
REM 
REM ArcGIS Engine 10.7.1の一括インストール
REM 
REM 以下を参考にして編集しました
...
REM Engineのインストール
echo ArcGIS Engine 10.7.1 のインストールを開始します
...
echo ArcGIS Engine 10.7.1 のインストール... インストールにはしばらく時間がかかります...
...
REM 日本語パックのインストール
echo ArcGIS Engine 10.7.1 日本語パック のインストール...
%windir%\System32\msiexec.exe /I "%curpath%\Engine_Japanese\SetupFiles\Supplement\EngineJapanese.msi" /norestart /passive /qb


REM 国内対応パックのインストール
echo ArcGIS Engine 10.7.1 国内対応パック のインストール...
%windir%\System32\msiexec.exe /I "%curpath%\Engine_JpnPack\JpnPack_Engine10_7_1.msi" /norestart /passive /qb
...
echo ArcGIS Engine 10.7.1 64-bit Background Geoprocessing のインストール...
...
echo ArcGIS Engine 10.7.1のインストール終了
