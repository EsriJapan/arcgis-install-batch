...
echo.
echo -----------------------------------
echo ArcGIS Pro 3.6 の一括インストール の対象
echo -----------------------------------
echo ・ArcGIS Pro 3.6
...
REM デスクトップのインストール
echo ArcGIS Pro 3.6 のインストールを開始します
...
echo ArcGIS Pro 3.6 本体のインストール... インストールにはしばらく時間がかかります...
...
echo ArcGIS Pro 3.6 日本語パック のインストール...
...
echo ArcGIS Pro 3.6 Patch 1 のインストール...
%windir%\System32\msiexec.exe /p "%curpath%\ArcGISPro_Patches\ArcGIS_Pro_361_198430.msp" /norestart /passive /qb

echo ArcGIS Pro 3.6 Patch 2 のインストール...
%windir%\System32\msiexec.exe /p "%curpath%\ArcGISPro_Patches\ArcGIS_Pro_362_198429.msp" /norestart /passive /qb
...
REM echo ArcGIS Pro 3.6 Data Interoperability のインストール...
...
REM echo ArcGIS Pro 3.6 Data Interoperability のインストール終了
REM echo.
...
REM その他:日本用地図シンボルなど
echo.
echo 注1)ArcGIS Pro 3.6 用 データベースサポートファイル は必要に応じてMy Esriから入手してインストールしてください
